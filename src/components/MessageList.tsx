    ...
    <div className="flex flex-col gap-2 px-4">
        {messages.map(message => {
            return (
                ...
                >
                    <div className={cn('max-w-sm rounded-lg px-3 text-sm py-1 my-2 shadow-md ring-1 ring-gray-900/10', {
                        'text-start bg-blue-300 dark:bg-blue-700 text-black dark:text-white': message.role === 'user',
